...
def bottleneck(inputs, depth, depth_bottleneck, stride, rate=1,
               outputs_collections=None, scope=None, trainable=True):
    ...
    with tf.variable_scope(scope, 'bottleneck_v2', [inputs]) as sc:
        ...
        if depth == depth_in:
            ...
            shortcut = slim.conv2d(preact, depth, [1, 1], stride=stride,
                                   ...
                                   scope='shortcut', trainable=trainable)

        residual = slim.conv2d(preact, depth_bottleneck, [1, 1], stride=1,
                               scope='conv1', trainable=trainable)
        residual = resnet_utils.conv2d_same(residual, depth_bottleneck, 3, stride,
                                            rate=rate, scope='conv2', trainable=trainable)
        ...
        with slim.arg_scope([slim.conv2d, bottleneck,
            ...
            if include_root_block:
                ...
                with slim.arg_scope([slim.conv2d],
                    ...
                    net = resnet_utils.conv2d_same(net, 64, 7, stride=2, scope='conv1', trainable=False)
